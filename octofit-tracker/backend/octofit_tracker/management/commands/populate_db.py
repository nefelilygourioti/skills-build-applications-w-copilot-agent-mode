    ...
    def handle(self, *args, **kwargs):
        ...
        try:
            with transaction.atomic():
                # Clear existing data
                logging.debug('Clearing existing data from collections.')
                ...
                logging.debug('Successfully populated the database with test data.')
                self.stdout.write(self.style.SUCCESS('Successfully populated the database with test data.'))
        except Exception as e:
            logging.error(f'Error while populating the database: {e}')
            self.stdout.write(self.style.ERROR(f'Error while populating the database: {e}'))